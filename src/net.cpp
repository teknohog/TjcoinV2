...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TjcoinV2 " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tjcoin.org", "dnsseed.tjcoin.org"},
    {"taobishidai.com", "dnsseed.taobishidai.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"TjcoinV2tools.com", "testnet-seed.TjcoinV2tools.com"},
...
{
    {
        LOCK(cs_vAddedNodes);
               ...
               vAddedNodes.push_back("27.192.118.14");
               vAddedNodes.push_back("222.90.231.43");
               vAddedNodes.push_back("115.29.220.142");
               vAddedNodes.push_back("202.96.138.245");
               vAddedNodes.push_back("huolongyema.eicp.net:9488");
               vAddedNodes.push_back("taojingcoin.oicp.net:9488");
               vAddedNodes.push_back("222.90.231.43");
               vAddedNodes.push_back("taojingcoin.oicp.net:9488");
               vAddedNodes.push_back("125.65.113.84:9488");
               vAddedNodes.push_back("119.115.143.154:9488");
               vAddedNodes.push_back("221.202.125.246:9488");
               vAddedNodes.push_back("103.242.132.236");
               vAddedNodes.push_back("219.139.158.74");
               vAddedNodes.push_back("112.124.109.192");
               vAddedNodes.push_back("tjc2.cn-soft.com:9488");
               vAddedNodes.push_back("115.28.22.67:9488");
               vAddedNodes.push_back("kangmang9.oicp.net:9488");
               vAddedNodes.push_back("zl6193252.vicp.cc:9488");
               vAddedNodes.push_back("sz709920088.oicp.net:9488");
               vAddedNodes.push_back("memofish.vicp.cc:9488");
               vAddedNodes.push_back("cnjtc.eicp.net:9488");
               vAddedNodes.push_back("115.29.220.142:9488");
               vAddedNodes.push_back("58.242.239.211:9488");
               vAddedNodes.push_back("202.96.138.245:9488");
               vAddedNodes.push_back("183.44.126.92:9488");
               vAddedNodes.push_back("116.255.158.214:9488");
               vAddedNodes.push_back("112.244.1.136:9488");
    }
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TjcoinV2 is probably already running."), addrBind.ToString().c_str());
        else
